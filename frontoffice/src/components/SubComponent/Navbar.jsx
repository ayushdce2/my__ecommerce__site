...
//   };
const handlesetMobilemainMenu=(e)=>{
  e.preventDefault();
  setMobilemainMenu(true);
}
  return (
    <>
    <nav className=" shadow-sm sticky top-0 z-30 bg-[#0B1F33]">
        <div className="md:max-w-7xl mx-auto px-6 py-4 flex items-center justify-center md:justify-between flex-wrap gap-5 ">
          ...
          <div className="hidden md:flex gap-8 font-medium ">
            ...
            <Link to="/contact" className={` p-2 rounded-lg  transition headingfont  font-bold ${pathname=="/contact" ? "bg-[#f75002] text-[#0B1F33] hover:text-gray-300 " : "text-gray-300 hover:text-[#f75002] "}`}>Contact Us</Link>            
          </div>
          ...
          <div className="flex items-center gap-4 mx-auto md:m-0 ">
            ...
            <IoMenu className="text-4xl text-gray-200 md:hidden " onClick={handlesetMobilemainMenu}/>
            <CategorySelect/>
      ...
      {
        MobilemainMenu && (
          <div className="fixed h-screen inset-0 bg-[#0B1F33] z-30 flex items-center justify-center"onClick={()=>{setMobilemainMenu(false)}}>
          <div className="flex flex-col gap-8 font-medium md:hidden ">
            <Link to="/" className={` p-2 rounded-lg  transition headingfont  font-bold ${pathname=="/" ? "bg-[#f75002] text-[#0B1F33] hover:text-gray-300 " : "text-gray-300 hover:text-[#f75002] "}`}>Home</Link>
            {/* <Link to="/category" className="hover:text-indigo-600 transition">Category</a> */}
            <Link to="/about" className={` p-2 rounded-lg  transition headingfont  font-bold ${pathname=="/about" ? "bg-[#f75002] text-[#0B1F33] hover:text-gray-300 " : "text-gray-300 hover:text-[#f75002] "}`}>About</Link>
            <Link to="/orderguide" className={` p-2 rounded-lg  transition headingfont  font-bold ${pathname=="/orderguide" ? "bg-[#f75002] text-[#0B1F33] hover:text-gray-300 " : "text-gray-300 hover:text-[#f75002] "}`}>Order Guide</Link>
